...
data class Env(
	...
	data class TMDB(
		...
		val movieProviders: List<Pair<Int, String>> = listOf(
			8 to "Netflix",
			119 to "Amazon Prime Video",
			9 to "Amazon Prime Video",
			15 to "Hulu",
			...
			283 to "Crunchyroll",
			386 to "Peacock",
			387 to "Peacock Premium",
			10 to "Amazon Video",
			192 to "YouTube",
			269 to "Funimation Now",
			207 to "The Roku Channel",
			337 to "Disney Plus",
		...
		val tvProviders: List<Pair<Int, String>> = listOf(
			8 to "Netflix",
			9 to "Amazon Prime Video",
			15 to "Hulu",
			531 to "Paramount Plus",
